...
public class FolderSelectorTag extends IncludeTag {
	...
	public void setRemoveButtonDisabled(boolean removeButtonDisabled) {
		_removeButtonDisabled = removeButtonDisabled;
	}
	...
	protected void setAttributes(HttpServletRequest httpServletRequest) {
		...
		httpServletRequest.setAttribute(
			"liferay-frontend:folder-selector:removeButtonDisabled",
	...
	private boolean _removeButtonDisabled;
