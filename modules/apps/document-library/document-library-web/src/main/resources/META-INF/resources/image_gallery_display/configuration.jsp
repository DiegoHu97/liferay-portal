		...
		>
			<aui:field-wrapper>
				<liferay-frontend:folder-selector
					...
					parentFolderInTrash="<%= igConfigurationDisplayContext.isRootFolderInTrash() %>"
					parentFolderLabel="<%= igConfigurationDisplayContext.getRootFolderName() %>"
					parentFolderNotFound="<%= igConfigurationDisplayContext.isRootFolderNotFound() %>"
					parentFolderValue="<%= igConfigurationDisplayContext.getRootFolderId() %>"
					selectEventName="folderSelected"
					selectFolderURL="<%= igConfigurationDisplayContext.getSelectRootFolderURL() %>"
				/>
			</aui:field-wrapper>
		</liferay-frontend:fieldset>
	</liferay-frontend:edit-form-body>
